import api.{AnalyticsApi, AuthApi, CorrectionApi, RealtyObjectApi, RealtyObjectPoolApi}
...
import services.{AnalyticsService, AuthService, CorrectionService, GeoSuggestionService, RealtyObjectPoolService, RealtyObjectService, SearchRealtyService}
